/*! Lab1TestAdvanced3
 *  Used for advanced LED blinking with the FRDM-KL46Z.  This adds a .hpp file to leverage modularity and also provides an example of a proper commenting style.
 * @code
 * #include "mbed.h"
 * #include "Blinker.h"
 *
